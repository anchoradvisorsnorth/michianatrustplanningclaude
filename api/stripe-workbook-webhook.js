...
export default async function handler(req, res) {
  ...
  const WORKBOOK_BASE    = `${SITE}/dl/wkb-9f3a7c2e`;
  ...
  try {
    const emailRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: email,
        subject: 'Your Indiana Trust Planning Workbook — Download Inside',
        html: `
          <div style="font-family:'Helvetica Neue',sans-serif;max-width:560px;margin:0 auto;color:#253040">
            ...
            <div style="padding:36px 32px">
              ...
              <p style="font-size:15px;line-height:1.7;color:#4a5568;margin:0 0 20px">
                Thank you for your purchase. Your Indiana Revocable Living Trust Workbook is ready to download in two formats:
              </p>
              <div style="margin:0 0 12px">
                <a href="${WORKBOOK_BASE}/mtp-workbook-fillable-v2.pdf"
              ...
              <div style="margin:0 0 28px">
                <a href="${WORKBOOK_BASE}/mtp-workbook-printable-v3.pdf"
                   style="display:inline-block;background:#243347;color:#fff;font-weight:700;font-size:15px;padding:14px 28px;border-radius:8px;text-decoration:none">
              ...
              <div style="background:#faf8f4;border-left:3px solid #b07d2e;padding:20px 24px;margin:0 0 0;border-radius:0 6px 6px 0">
                ...
                <p style="font-size:14px;line-height:1.7;color:#4a5568;margin:0 0 14px">
                  The workbook helps you plan. The <strong>Complete Indiana Trust Bundle</strong> gives you all 7 attorney-reviewed documents — personalized, delivered to your inbox, ready to sign and notarize. Everything you need, for $199.
                </p>
